...
import org.liurongchan.listener.Secondary_Forum_Category_Listener;
 ...
 * @version 创建时间：2014-3-28 下午2:53:23
 * 类说明
 */
public class SecondaryForumCategory_Adapter extends BaseAdapter {
	private Context mContext;
	private String[] mCategories;

	private LayoutInflater mLayoutInflater;

	public SecondaryForumCategory_Adapter(Context context, String[] categories) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView.setOnClickListener(new Secondary_Forum_Category_Listener(mContext, mCategories[position]));
		return convertView;
	}
